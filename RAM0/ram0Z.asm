...
SECTION BANK_00
include "WYZproPlay47bZX.ASM";attention new
;include "wyz_effects.asm"
include "wyz_variables.asm";attention new

; this is for the instruments in the game
include "EXTERNAL.mus.asm";attention new
